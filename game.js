class Game {
  ...
  async start(){
    ...
    p4.scale=0.3;
    ps = [p1, p2, p3, p4];
    hurdle1 = createSprite(650,500,10,50);
    hurdle2 = createSprite(650,630,10,50);
    hurdle3= createSprite(650,740,10,50);
    hurdle4 = createSprite(650,870,10,50);

    hurdle5 = createSprite(3350,500,10,50);
    hurdle6 = createSprite(3350,630,10,50);
    hurdle7= createSprite(3350,740,10,50);
    hurdle8 = createSprite(3350,870,10,50);
  ...
  if(allPlayers !== undefined){
    background(100);
    image(track,0,300,displayWidth*5,displayHeight);
    ...
    ps[index-1].collide(hurdle4)||ps[index-1].collide(hurdle5)||ps[index-1].collide(hurdle6)||ps[index-1].collide(hurdle7)||ps[index-1].collide(hurdle8)){    
